...
void Texture::UseTexture()
{
	...
	glActiveTexture(GL_TEXTURE0);//uniform sampler2D theTexture; in the fragment shader file is referencing this texture. by default it is 0 which is why we are not specifying a number in the fragment file. if there were multipe shaders. we would
	glBindTexture(GL_TEXTURE_2D, textureID);
}
